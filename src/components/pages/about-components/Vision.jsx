    ...
    <>
      ...
      <div className="approach">
        ...
        <div className="image-within-text">
          <p> <img className='image-size' src={IntroImg2} alt="intro" style={{ float: 'right', marginLeft: '10px' }} />We strive to break down barriers and change societal expectations, ensuring that girls can lead and innovate in science, technology, engineering, and mathematics, contributing to a diverse, balanced, and advanced global community.</p>
        </div>
        ...
        <div className="image-within-text">
          ...
          <p> Creating a supportive community where girls can share their experiences, challenges, and successes. This could be facilitated through online platforms, clubs, and annual conferences that enable networking and camaraderie.
</p>

        <div className="image-within-text">
          <h1> Hands-On Learning:</h1>
          <p> Organizing workshops, camps, and interactive sessions that allow girls to engage directly with STEM activities. Practical exposure is key to sparking interest and helping them visualize themselves in those roles.</p>
        </div>
      </div>
    </>
  )
