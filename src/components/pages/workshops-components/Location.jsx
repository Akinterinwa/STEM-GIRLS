  ...
  return (
    <>
        ...
        <div className="location">
          <h2>Inspire STEM Girl (ISG) currently offers workshops in the following locations:</h2>
          ...
          <div className="cta">
            <p className='cta-link'><a href="/volunteer">Click here</a> to get involved as a volunteer in one of these areas</p>
            <p className='cta-link'> <a href="/start-new">Click here</a> for information on starting a STEM Like a Girl site in a new location</p>
          </div>
        </div>
    </>
  )
