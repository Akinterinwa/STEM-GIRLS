        ...
        <>
            <div className="focus">
                <div className="focus-container">
                    ...
                    <p>Inspire STEM Girls' mission is to cultivate an empowering environment that encourages young girls to explore and excel in the fields of science, technology, engineering, and mathematics (STEM).</p>
                    <Link to="/mission">
