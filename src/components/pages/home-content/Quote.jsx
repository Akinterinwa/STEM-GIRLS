    ...
    <>
      <div className="quote-container">
        <div className="quotes-img">
          <img src="/image.svg" alt="container" />
        </div>
      ...
      <div className="mentorship-coding">
        <div className="coding-container">
          <div className="coding-content">
            ...
            <p>Be a part of the movement to break barriers and empower young women in STEM fields. Your support can change lives. Donate now and help us pave the way for a brighter, more inclusive future.</p>
